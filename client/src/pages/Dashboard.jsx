    ...
    const fetchEverything = async () => {
      try {
        ...
        const [invRes, statsRes, forecastRes, insightRes] = await Promise.all([
          axios.get('/api/v1/invoices', { headers }),
          axios.get('/api/v1/analytics/stats', { headers }),
          axios.get('/api/v1/analytics/forecast', { headers }),
          axios.get('/api/v1/analytics/insight-x', { headers })
        ]);
